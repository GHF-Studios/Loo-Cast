...
| `core_mod` | Engine init + assets | Engine-owned assets/config/content-domain declarations. |
...
| `base_mod` | Gameplay init + assets | Gameplay-facing content declarations/configs/assets. |
| `base_mod_api` | Gameplay capability bindings | Rhai-facing wrappers for gameplay capability exposure. |
