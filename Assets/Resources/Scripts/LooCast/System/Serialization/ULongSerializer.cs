...
namespace LooCast.System.Serialization
{
    public sealed class ULongSerializer : IPrimitiveAttributeSerializer<ulong>
    {
        ...
        #region Methods
        public void Serialize(object primitiveAttribute, out XAttribute serializedPrimitiveAttribute) => Serialize((ulong)primitiveAttribute, out serializedPrimitiveAttribute);

        public void Serialize(ulong primitiveAttribute, out XAttribute serializedPrimitiveAttribute)
        {
