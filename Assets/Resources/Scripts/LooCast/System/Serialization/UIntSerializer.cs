...
namespace LooCast.System.Serialization
{
    public sealed class UIntSerializer : IPrimitiveAttributeSerializer<uint>
    {
        ...
        #region Methods
        public void Serialize(string primitiveAttributeName, object primitiveAttribute, out XAttribute serializedPrimitiveAttribute) => Serialize(primitiveAttributeName, (uint)primitiveAttribute, out serializedPrimitiveAttribute);
