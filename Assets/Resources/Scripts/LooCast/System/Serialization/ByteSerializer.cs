...
namespace LooCast.System.Serialization
{
    public sealed class ByteSerializer : IPrimitiveAttributeSerializer<byte>
    {
        ...
        #region Methods
        public void Serialize(object primitiveAttribute, out XAttribute serializedPrimitiveAttribute) => Serialize((byte)primitiveAttribute, out serializedPrimitiveAttribute);

        public void Serialize(byte primitiveAttribute, out XAttribute serializedPrimitiveAttribute)
        {
