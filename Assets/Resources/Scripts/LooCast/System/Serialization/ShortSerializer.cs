...
namespace LooCast.System.Serialization
{
    public sealed class ShortSerializer : IPrimitiveAttributeSerializer<short>
    {
        ...
        #region Methods
        public void Serialize(object primitiveAttribute, out XAttribute serializedPrimitiveAttribute) => Serialize((short)primitiveAttribute, out serializedPrimitiveAttribute);

        public void Serialize(short primitiveAttribute, out XAttribute serializedPrimitiveAttribute)
        {
