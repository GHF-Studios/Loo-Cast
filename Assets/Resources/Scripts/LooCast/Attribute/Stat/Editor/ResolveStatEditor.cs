...
namespace LooCast.Attribute.Stat.Editor
{
    ...
    public class ResolveStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty PiercingIncrease;
        ...
        void OnEnable()
        {
            ...
            PiercingIncrease = serializedObject.FindProperty("PiercingIncrease");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(PiercingIncrease);
