...
{
    [CustomEditor(typeof(KnowledgeStat))]
    public class KnowledgeStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty LevelExperienceMaxMultiplier;
        ...
        void OnEnable()
        {
            ...
            LevelExperienceMaxMultiplier = serializedObject.FindProperty("LevelExperienceMaxMultiplier");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(LevelExperienceMaxMultiplier);
