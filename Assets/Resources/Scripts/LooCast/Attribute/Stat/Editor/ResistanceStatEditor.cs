...
{
    [CustomEditor(typeof(ResistanceStat))]
    public class ResistanceStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty DefenseIncrease;
        ...
        void OnEnable()
        {
            ...
            DefenseIncrease = serializedObject.FindProperty("DefenseIncrease");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(DefenseIncrease);
