...
{
    [CustomEditor(typeof(QuicknessStat))]
    public class QuicknessStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty AttackDelayMultiplier;
        ...
        void OnEnable()
        {
            ...
            AttackDelayMultiplier = serializedObject.FindProperty("AttackDelayMultiplier");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(AttackDelayMultiplier);
