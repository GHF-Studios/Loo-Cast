...
{
    [CustomEditor(typeof(PowerStat))]
    public class PowerStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty KnockbackMultiplier;
        ...
        void OnEnable()
        {
            ...
            KnockbackMultiplier = serializedObject.FindProperty("KnockbackMultiplier");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(KnockbackMultiplier);
