...
{
    [CustomEditor(typeof(BodyStat))]
    public class BodyStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty EnergyMultiplier;
        ...
        void OnEnable()
        {
            ...
            EnergyMultiplier = serializedObject.FindProperty("EnergyMultiplier");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(EnergyMultiplier);
