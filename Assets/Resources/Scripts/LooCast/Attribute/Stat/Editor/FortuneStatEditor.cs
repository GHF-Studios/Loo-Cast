...
{
    [CustomEditor(typeof(FortuneStat))]
    public class FortuneStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty PositiveEventChanceMultiplier;
        ...
        void OnEnable()
        {
            ...
            PositiveEventChanceMultiplier = serializedObject.FindProperty("PositiveEventChanceMultiplier");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(PositiveEventChanceMultiplier);
