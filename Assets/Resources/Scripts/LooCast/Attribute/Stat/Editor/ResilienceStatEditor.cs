...
{
    [CustomEditor(typeof(ResilienceStat))]
    public class ResilienceStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty ShieldStrengthIncrease;
        ...
        void OnEnable()
        {
            ...
            ShieldStrengthIncrease = serializedObject.FindProperty("ShieldStrengthIncrease");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(ShieldStrengthIncrease);
