...
{
    [CustomEditor(typeof(SanityStat))]
    public class SanityStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty ProjectileSizeMultiplier;
        ...
        void OnEnable()
        {
            ...
            ProjectileSizeMultiplier = serializedObject.FindProperty("ProjectileSizeMultiplier");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(ProjectileSizeMultiplier);
