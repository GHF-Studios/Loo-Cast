...
{
    [CustomEditor(typeof(EgoStat))]
    public class EgoStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty DamageReflection;
        ...
        void OnEnable()
        {
            ...
            DamageReflection = serializedObject.FindProperty("DamageReflection");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(DamageReflection);
