...
{
    [CustomEditor(typeof(RecoveryStat))]
    public class RecoveryStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty HealthRegenrationMultiplier;
        ...
        void OnEnable()
        {
            ...
            HealthRegenrationMultiplier = serializedObject.FindProperty("HealthRegenrationMultiplier");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(HealthRegenrationMultiplier);
