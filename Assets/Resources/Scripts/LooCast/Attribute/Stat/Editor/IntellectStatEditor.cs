...
{
    [CustomEditor(typeof(IntellectStat))]
    public class IntellectStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty ExperienceMultiplier;
        ...
        void OnEnable()
        {
            ...
            ExperienceMultiplier = serializedObject.FindProperty("ExperienceMultiplier");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(ExperienceMultiplier);
