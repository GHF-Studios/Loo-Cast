...
{
    [CustomEditor(typeof(StaminaStat))]
    public class StaminaStatEditor : UnityEditor.Editor
    {
        ...
        void OnEnable()
        {
            ...
            DurationMultiplier = serializedObject.FindProperty("DurationMultiplier");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(DurationMultiplier);
