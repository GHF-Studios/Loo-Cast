...
{
    [CustomEditor(typeof(BrawnStat))]
    public class BrawnStatEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty ArmorPenetrationIncrease;
        ...
        void OnEnable()
        {
            ...
            ArmorPenetrationIncrease = serializedObject.FindProperty("ArmorPenetrationIncrease");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(ArmorPenetrationIncrease);
