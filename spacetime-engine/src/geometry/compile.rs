...
fn compile_box(value: &BoxDef) -> CompiledGeometry {
    CompiledGeometry {
        id: value.id.clone(),
        zone: value.zone.clone(),
        tags: value.tags.clone(),
...
fn compile_cylinder(value: &CylinderDef) -> CompiledGeometry {
    CompiledGeometry {
        id: value.id.clone(),
        zone: value.zone.clone(),
        tags: value.tags.clone(),
...
fn compile_sphere(value: &SphereDef) -> CompiledGeometry {
    CompiledGeometry {
        id: value.id.clone(),
        zone: value.zone.clone(),
        tags: value.tags.clone(),
...
fn compile_capsule(value: &CapsuleDef) -> CompiledGeometry {
    CompiledGeometry {
        id: value.id.clone(),
        zone: value.zone.clone(),
        tags: value.tags.clone(),
...
fn compile_convex_prism(value: &ConvexPrismDef) -> CompiledGeometry {
    CompiledGeometry {
        id: value.id.clone(),
        zone: value.zone.clone(),
        tags: value.tags.clone(),
...
fn compile_ramp(value: &RampDef) -> CompiledGeometry {
...
fn compile_staircase(output: &mut Vec<CompiledNode>, value: &StaircaseDef) {
...
fn compile_step_sweep(output: &mut Vec<CompiledNode>, value: &StepSweepDef) {
    let origin = v3(value.origin);
...
fn compile_slope_sweep(output: &mut Vec<CompiledNode>, value: &SlopeSweepDef) {
...
fn compile_pillar_grid(output: &mut Vec<CompiledNode>, value: &PillarGridDef) {
    let origin = v3(value.origin);
    let rotation = Quat::from_rotation_y(value.yaw_degrees.to_radians());
    let right = rotation * Vec3::X;
    let forward = rotation * Vec3::Z;
...
fn compile_moving_box(value: &MovingBoxDef) -> CompiledGeometry {
    CompiledGeometry {
        id: value.id.clone(),
        zone: value.zone.clone(),
        tags: value.tags.clone(),
...
fn compile_point_light(value: &PointLightDef) -> CompiledPointLight {
    CompiledPointLight {
        id: value.id.clone(),
        zone: value.zone.clone(),
