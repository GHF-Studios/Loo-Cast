...
#[repr(transparent)]
pub struct NormalVector<const D: usize>(pub Field<NormalVectorRepr<D>>);

#[derive(Clone, Debug, PartialEq)]
pub enum NormalVectorRepr<const D: usize> {
    Generic(NormalVectorGenericRepr<D>),
    Concrete(NormalVectorConcreteRepr),
}

#[derive(Clone, Debug, PartialEq)]
pub enum NormalVectorGenericRepr<const D: usize> {
...
#[derive(Clone, Debug, PartialEq)]
pub enum NormalVectorConcreteRepr {
...
impl super::shared::Vector2dFieldOps for NormalVector<3> {}
impl super::shared::Vector2dFieldOps for NormalVector<4> {}
impl super::shared::Vector3dFieldOps for NormalVector<3> {}
impl super::shared::Vector3dFieldOps for NormalVector<4> {}
