...
#[repr(transparent)]
pub struct NormalQuaternion(pub Field<NormalQuaternionRepr>);

#[derive(Clone, Debug, PartialEq)]
pub enum NormalQuaternionRepr {
    Generic(NormalQuaternionGenericRepr),
    Concrete(NormalQuaternionConcreteRepr),
}

#[derive(Clone, Debug, PartialEq)]
pub enum NormalQuaternionGenericRepr {
...
#[derive(Clone, Debug, PartialEq)]
pub enum NormalQuaternionConcreteRepr {
