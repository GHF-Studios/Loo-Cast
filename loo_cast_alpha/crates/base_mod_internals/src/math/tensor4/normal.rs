...
#[repr(transparent)]
pub struct NormalTensor4<const A: usize, const B: usize, const C: usize, const D: usize>(pub Field<NormalTensor4Repr<A, B, C, D>>);

#[derive(Clone, Debug, PartialEq)]
pub enum NormalTensor4Repr<const A: usize, const B: usize, const C: usize, const D: usize> {
