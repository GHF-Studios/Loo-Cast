...
#[repr(transparent)]
pub struct NormalMatrix<const R: usize, const C: usize>(pub Field<NormalMatrixRepr<R, C>>);

#[derive(Clone, Debug, PartialEq)]
pub enum NormalMatrixRepr<const R: usize, const C: usize> {
    Generic(NormalMatrixGenericRepr<R, C>),
    Concrete(NormalMatrixConcreteRepr),
}

#[derive(Clone, Debug, PartialEq)]
pub enum NormalMatrixGenericRepr<const R: usize, const C: usize> {
...
#[derive(Clone, Debug, PartialEq)]
pub enum NormalMatrixConcreteRepr {
