...
Execution flows through profile-tailored Context API subgraphs that bound exposed capability objects via hierarchical
graph composition (atomic + composite nodes) and include/exclude path filters.
