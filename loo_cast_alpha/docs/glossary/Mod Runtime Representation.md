...
The runtime resolves typed declaration instances (for example scale, metric, phenomenon, and realizer definitions) into
executable behavior through the [[Modding Runtime]], the [[Capability Runtime]], and the [[USF Runtime]].
