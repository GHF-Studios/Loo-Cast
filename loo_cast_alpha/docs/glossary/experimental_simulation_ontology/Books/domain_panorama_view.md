---
canonical_name: Domain Panorama View (Projection Book, Experimental)
status: WIP-experimental
aliases: []
source_of_truth: []
---

This projection follows the full domain span goal.
It is coverage-first and intentionally broad.
...
- [paradigm.astro.grmhd](../Nodes/paradigm.astro.grmhd.md)
...
- [paradigm.biological.agent_based_systems](../Nodes/paradigm.biological.agent_based_systems.md)
...
- [paradigm.multiscale.qmmm_hybrid](../Nodes/paradigm.multiscale.qmmm_hybrid.md)
...
- [solver.ml.fno_inference](../Nodes/solver.ml.fno_inference.md)
