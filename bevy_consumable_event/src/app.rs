...
impl ConsumableEventApp for App {
    fn add_consumable_event<E: Event>(&mut self) -> &mut Self {
        self.init_resource::<ConsumableEvents<E>>().add_systems(First, clear_all_events::<E>)
    }

    fn add_persistent_consumable_event<E: Event>(&mut self) -> &mut Self {
        self.init_resource::<ConsumableEvents<E>>().add_systems(First, clear_consumed_events::<E>)
    }
}
