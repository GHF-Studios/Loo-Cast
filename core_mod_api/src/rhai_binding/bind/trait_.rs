use crate::rhai_binding::meta::{
    abstract_::trait_identity::{DynGetTraitName, DynGetTraitObjectName},
    monomorphized::trait_::*,
};

impl TraitMetadata {
    pub(super) fn register_trait(&self, parent_module: &mut rhai::Module)
    where
        Self: Sized,
    {
...
impl TraitObjectMetadata {
    pub(super) fn register_trait_object(&self, parent_module: &mut rhai::Module)
    where
        Self: Sized,
    {
