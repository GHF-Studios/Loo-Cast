use crate::{rhai_binding::{meta::{generic::abstract_primitive::ConstDynMetadata, monomorphized::impl_::{InherentImplMetadata, TraitImplMetadata}}, path::{function_path::{ConstructorFunctionPath, ItemAssociatedFunctionPath, MethodFunctionPath}, impl_path::{InherentImplPath, TraitImplPath}}}, utils::clone_lazy::CloneLazy};
