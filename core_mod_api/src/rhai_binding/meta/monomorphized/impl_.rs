use crate::{rhai_binding::{meta::generic::{abstract_primitive::ConstDynMetadata, impl_::{InherentImplConstDynMetadata, TraitImplConstDynMetadata}}, path::{function_path::*, impl_path::{InherentImplPath, TraitImplPath}}}, utils::clone_lazy::CloneLazy};
