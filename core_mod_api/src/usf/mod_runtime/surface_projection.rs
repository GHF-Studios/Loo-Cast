...
use crate::usf::mod_runtime::surface_field::{ROOT_AXIS_PERIOD_UNITS, canonical_grid_coord, sample_root_native_position};
use crate::usf::pos::grid::types::GridVec;
use crate::usf::scale::Scale;
use std::collections::{BTreeMap, HashSet};

#[derive(Debug, Clone, Copy)]
pub(crate) struct ChunkVisualCullCandidate {
    pub entity: Entity,
    pub coarse_depth: u8,
    pub distance_sq: f32,
    pub front_dot: f32,
...
pub(crate) fn select_visible_chunk_visual_entities(candidates: &[ChunkVisualCullCandidate], active_budget: usize) -> HashSet<Entity> {
...
#[inline]
pub(crate) fn chunk_visual_scale_in_active_native_space(chunk_scale: Scale, active_scale_index: i16) -> f32 {
