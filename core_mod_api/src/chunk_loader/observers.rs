...
pub(crate) fn on_remove_chunk_loader_observation_queue_processing_system(
    ...
    if removed_owner_id_scale_quecto_meter_000001.is_none()
        && removed_owner_id_scale_quecto_meter_00001.is_none()
        && removed_owner_id_scale_quecto_meter_0001.is_none()
        && removed_owner_id_scale_quecto_meter_001.is_none()
        && removed_owner_id_scale_quecto_meter_01.is_none()
        && removed_owner_id_scale_quecto_meter_1.is_none()
        && removed_owner_id_scale_quecto_meter_10.is_none()
        && removed_owner_id_scale_quecto_meter_100.is_none()
        && removed_owner_id_scale_ronto_meter_1.is_none()
        && removed_owner_id_scale_ronto_meter_10.is_none()
        && removed_owner_id_scale_ronto_meter_100.is_none()
        && removed_owner_id_scale_yocto_meter_1.is_none()
        && removed_owner_id_scale_yocto_meter_10.is_none()
        && removed_owner_id_scale_yocto_meter_100.is_none()
        && removed_owner_id_scale_zepto_meter_1.is_none()
        && removed_owner_id_scale_zepto_meter_10.is_none()
        && removed_owner_id_scale_zepto_meter_100.is_none()
        && removed_owner_id_scale_atto_meter_1.is_none()
        && removed_owner_id_scale_atto_meter_10.is_none()
        && removed_owner_id_scale_atto_meter_100.is_none()
        && removed_owner_id_scale_femto_meter_1.is_none()
        && removed_owner_id_scale_femto_meter_10.is_none()
        && removed_owner_id_scale_femto_meter_100.is_none()
        && removed_owner_id_scale_pico_meter_1.is_none()
        && removed_owner_id_scale_pico_meter_10.is_none()
        && removed_owner_id_scale_pico_meter_100.is_none()
        && removed_owner_id_scale_nano_meter_1.is_none()
        && removed_owner_id_scale_nano_meter_10.is_none()
        && removed_owner_id_scale_nano_meter_100.is_none()
        && removed_owner_id_scale_micro_meter_1.is_none()
        && removed_owner_id_scale_micro_meter_10.is_none()
        && removed_owner_id_scale_micro_meter_100.is_none()
        && removed_owner_id_scale_milli_meter_1.is_none()
        && removed_owner_id_scale_milli_meter_10.is_none()
        && removed_owner_id_scale_milli_meter_100.is_none()
        && removed_owner_id_scale_meter_1.is_none()
        && removed_owner_id_scale_meter_10.is_none()
        && removed_owner_id_scale_meter_100.is_none()
        && removed_owner_id_scale_kilo_meter_1.is_none()
        && removed_owner_id_scale_kilo_meter_10.is_none()
        && removed_owner_id_scale_kilo_meter_100.is_none()
        && removed_owner_id_scale_mega_meter_1.is_none()
        && removed_owner_id_scale_mega_meter_10.is_none()
        && removed_owner_id_scale_mega_meter_100.is_none()
        && removed_owner_id_scale_giga_meter_1.is_none()
        && removed_owner_id_scale_giga_meter_10.is_none()
        && removed_owner_id_scale_giga_meter_100.is_none()
        && removed_owner_id_scale_tera_meter_1.is_none()
        && removed_owner_id_scale_tera_meter_10.is_none()
        && removed_owner_id_scale_tera_meter_100.is_none()
        && removed_owner_id_scale_peta_meter_1.is_none()
        && removed_owner_id_scale_peta_meter_10.is_none()
        && removed_owner_id_scale_peta_meter_100.is_none()
        && removed_owner_id_scale_exa_meter_1.is_none()
        && removed_owner_id_scale_exa_meter_10.is_none()
        && removed_owner_id_scale_exa_meter_100.is_none()
        && removed_owner_id_scale_zetta_meter_1.is_none()
        && removed_owner_id_scale_zetta_meter_10.is_none()
        && removed_owner_id_scale_zetta_meter_100.is_none()
        && removed_owner_id_scale_yotta_meter_1.is_none()
        && removed_owner_id_scale_yotta_meter_10.is_none()
        && removed_owner_id_scale_yotta_meter_100.is_none()
        && removed_owner_id_scale_ronna_meter_1.is_none()
        && removed_owner_id_scale_ronna_meter_10.is_none()
        && removed_owner_id_scale_ronna_meter_100.is_none()
        && removed_owner_id_scale_quetta_meter_1.is_none()
        && removed_owner_id_scale_quetta_meter_10.is_none()
        && removed_owner_id_scale_quetta_meter_100.is_none()
        && removed_owner_id_scale_quetta_meter_1000.is_none()
        && removed_owner_id_scale_quetta_meter_10000.is_none()
        && removed_owner_id_scale_quetta_meter_100000.is_none()
    {
        return;
    }
