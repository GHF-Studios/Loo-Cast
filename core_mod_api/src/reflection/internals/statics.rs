...
use super::types::RawReflectionMetadata;
...
export_static!(self, crate::reflection::internals::statics::RAW_REFLECTION_METADATA: Lazy<RawReflectionMetadata> = Lazy::new(|| RawReflectionMetadata::build()));
