...
use super::field::{CHUNK_SPAN_UNITS_I64, ChunkRealizationRecord, HALF_CHUNK_SPAN_F32};

pub(crate) fn build_chunk_mesh(record: &ChunkRealizationRecord) -> Option<Mesh> {
    ...
    let rho_values = record.density_cache.expand(total_points)?;
