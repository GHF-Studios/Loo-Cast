    ...
    futures::executor::block_on(async move {
        ...
        let (device, queue) = adapter
            .request_device(&wgpu::DeviceDescriptor {
                label: Some("USF Realization Density GPU Device"),
        ...
        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("USF Realization Density Shader"),
            source: wgpu::ShaderSource::Wgsl(Cow::Borrowed(GPU_DENSITY_SHADER)),
        });
        let bind_group_layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            label: Some("USF Realization Density Bind Group Layout"),
            entries: &[
        ...
        let pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: Some("USF Realization Density Pipeline Layout"),
            bind_group_layouts: &[&bind_group_layout],
            push_constant_ranges: &[],
        });
        let pipeline = device.create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
            label: Some("USF Realization Density Pipeline"),
...
impl GpuDensityContext {
    fn sample(
        ...
        let params_buffer = self.device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("USF Realization Density Params Buffer"),
        ...
        let axis_buffer = self.device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("USF Realization Density Axis Buffer"),
        ...
        let output_buffer = self.device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("USF Realization Density Output Buffer"),
            size: output_padded_bytes as u64,
            usage: wgpu::BufferUsages::STORAGE | wgpu::BufferUsages::COPY_SRC,
            mapped_at_creation: false,
        });
        let readback_buffer = self.device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("USF Realization Density Readback Buffer"),
            size: output_padded_bytes as u64,
        ...
        let bind_group = self.device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("USF Realization Density Bind Group"),
        ...
        let mut encoder = self.device.create_command_encoder(&wgpu::CommandEncoderDescriptor {
            label: Some("USF Realization Density Command Encoder"),
        });
        {
            let mut compute_pass = encoder.begin_compute_pass(&wgpu::ComputePassDescriptor {
                label: Some("USF Realization Density Compute Pass"),
