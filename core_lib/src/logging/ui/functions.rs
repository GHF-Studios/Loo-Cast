...
pub fn render_module_tree(
    ui: &mut egui::Ui,
    module_registry: &mut crate::logging::types::ModuleRegistry,
    module_selections: &mut crate::logging::types::ModulePathSelections,
) {
...
pub fn render_physical_tree(
    ui: &mut egui::Ui,
    physical_registry: &mut crate::logging::types::PhysicalRegistry,
    physical_selections: &mut crate::logging::types::PhysicalPathSelections,
) {
    ScrollArea::vertical().show(ui, |ui| {
