...
// Implementations
impl EntityMetadata {
    pub fn new(parent_chunk: Arc<Mutex<Chunk>>, local_entity_pos: LocalEntityPos) -> Result<EntityMetadata, String> {
        ...
        let parent_chunk_metadata = match ChunkManager::get_metadata(&*parent_chunk_temp) {
            ...
            Err(e) => return Err(format!("Failed to get the metadata of the parent chunk: {}", e)),
        };
