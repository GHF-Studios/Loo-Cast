...
use crate::engine::system::player::*;
...
use crate::engine::system::universe::entity::pos::*;
use crate::engine::system::universe::entity::*;
use crate::engine::system::universe::global::*;
...
pub struct LocalUniverse {
    pub(in crate::engine::system::universe) id: LocalUniverseID,
    pub(in crate::engine::system::universe) previously_viewed_local_chunk_positions: Vec<ApparentLocalChunkPos>,
    pub(in crate::engine::system::universe) currently_viewed_local_chunk_positions: Vec<ApparentLocalChunkPos>,
    pub(in crate::engine::system::universe) newly_viewed_local_chunk_positions: Vec<ApparentLocalChunkPos>,
}
