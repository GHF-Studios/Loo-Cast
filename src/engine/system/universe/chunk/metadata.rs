...
pub struct ChunkMetadata {
    pub(in crate::engine::system::universe) parent_chunk: Option<Arc<Mutex<Chunk>>>,
    pub(in crate::engine::system::universe) absolute_local_chunk_pos: AbsoluteLocalChunkPos,
}
