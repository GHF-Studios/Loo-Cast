...
pub struct ChunkOperationRequest {
    pub(in crate::engine::system::universe) operations: Vec<ChunkOperation>,
}
...
impl Chunk {
    pub(in crate::engine::system::universe) fn new(id: ChunkID, bevy_entity: bevy::ecs::entity::Entity) -> Self {
