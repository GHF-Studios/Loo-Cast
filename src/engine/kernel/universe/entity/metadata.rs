...
pub struct EntityMetadata {
    pub(in crate::engine::kernel::universe) parent_local_universe: Arc<Mutex<LocalUniverse>>,
    pub(in crate::engine::kernel::universe) parent_chunk: Arc<Mutex<Chunk>>,
    pub(in crate::engine::kernel::universe) pos: EntityPos,
}
