...
impl Plugin for SaveGamePlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_systems(
                Update,
                (SaveGameManager::handle_delete_save_game).run_if(in_state(AppState::SaveGamesMenu)),
            )
            .add_systems(
                Update,
                (SaveGameManager::handle_create_save_game).run_if(in_state(AppState::CreateSaveGameMenu)),
            );
    }
}
