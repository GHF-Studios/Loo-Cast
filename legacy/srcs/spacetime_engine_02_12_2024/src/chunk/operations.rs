use bevy::prelude::*;
use crate::{chunk_actor::{components::ChunkActor, wrappers::ChunkActorInstanceRegistry}, chunk_loader::components::ChunkLoader, core::{components::*, singletons::*}, entity::wrappers::EntityInstanceRegistry, operation::traits::*};
...
pub struct UpgradeToChunkArgs {
    ...
    pub chunk_owner: Option<NumericID<ChunkLoader>>,
}
...
pub struct DowngradeFromChunkArgs {
    pub chunk_entity_id: NumericID<Entity>,
    pub chunk_id: NumericID<Chunk>,
}
