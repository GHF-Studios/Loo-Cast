...
pub struct GameInfo {
	game_id: GameID,
	name: String,
	game_config_info: GameConfigInfo,
	game_state_info: GameStateInfo,
	global_universe_info: GlobalUniverseInfo,
	local_universe_infos: Vec<LocalUniverseInfo>,
}
...
impl struct GameHandle {
	pub fn get_game_info() -> Result<GameHandleGetInfoError, &GameInfo> {}
	pub fn get_config_handle() -> Result<GameHandleGetConfigHandleError, GameConfigHandle> {}
	pub fn get_state_handle() -> Result<GameHandleGetStateHandleError, GameStateHandle>
}
