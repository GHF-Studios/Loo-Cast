...
pub(super) fn post_update_game_time_info(
    ...
    if virtual_time.is_paused() {
        ...
        match time_info.pause_state {
            ...
            PauseState::Step => match (*step_config, time_info.step_config) {
...
#[tracing::instrument(skip_all)]
pub(super) fn extract_game_time_info(world: &mut World) {
...
#[tracing::instrument(skip_all)]
pub(super) fn extract_virtual_paused(world: &mut World) {
    let main_world = SystemState::<Res<MainWorld>>::new(world).get(world);
