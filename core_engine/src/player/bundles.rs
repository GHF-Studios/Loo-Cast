...
use crate::{chunk_actor::components::ChunkActorComponent, chunk_loader::components::ChunkLoaderComponent, utils::InitHook};
use bevy::prelude::*;
...
pub struct PlayerBundle {
    ...
    chunk_loader_init_hook: InitHook<ChunkLoaderComponent>,
...
impl Default for PlayerBundle {
    fn default() -> Self {
        PlayerBundle {
            ...
            chunk_loader_init_hook: InitHook::<ChunkLoaderComponent>::default(),
