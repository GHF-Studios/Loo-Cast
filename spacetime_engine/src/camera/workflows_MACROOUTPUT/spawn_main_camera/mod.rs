...
pub const NAME: &str = stringify!("SpawnMainCamera");
...
impl Type {
    pub fn create_workflow() -> crate::workflow::types::WorkflowType {
        crate::workflow::types::WorkflowType {
            name: self::NAME,
            stages: vec![crate::workflow::stage::Stage::Ecs(
                crate::workflow::stage::StageEcs {
                    index: 0,
                    name: stringify!("ValidateAndSpawn"),
                    signature: crate::workflow::stage::StageSignature::None,
                    run_ecs: Box::new(self::stages::validate_and_spawn::core_functions::run_ecs)
                        as Box<
                            dyn FnMut(
                    ...
                    handle_ecs_run_response: Box::new(
                        ...
                        >,
                         _failure_sender: Option<
                            crossbeam_channel::Sender<crate::workflow::events::StageFailureEvent>,
                        >| {
                    ...
                    completion_sender: crate::workflow::channels::get_stage_completion_sender()
                        .clone(),
                    failure_sender: None,
                },
            )],
