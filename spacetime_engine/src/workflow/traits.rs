...
pub trait WorkflowStageEcsWhile {
    ...
    fn run_ecs_while(&mut self, world: &mut World) -> TypedOutcome<(), ()>;
...
pub trait WorkflowStageEcsWhileE {
    ...
    fn run_ecs_while(
        &mut self,
        world: &mut World,
    ) -> Result<TypedOutcome<(), ()>, Self::Error>;
    fn handle_ecs_while_response(
        &mut self,
        stage_response: Option<Box<dyn Any + Send + Sync>>,
        completion_sender: Sender<(
...
pub trait WorkflowStageEcsWhileO {
    ...
    fn index(&self) -> usize;
    fn setup_ecs_while(&mut self, world: &mut World);
    fn run_ecs_while(&mut self, world: &mut World) -> TypedOutcome<(), Self::Output>;
    fn handle_ecs_while_response(
        &mut self,
        stage_response: Option<Box<dyn Any + Send + Sync>>,
        completion_sender: Sender<(
...
pub trait WorkflowStageEcsWhileOE {
    ...
    fn run_ecs_while(
        &mut self,
        world: &mut World,
    ) -> Result<TypedOutcome<(), Self::Output>, Self::Error>;
    fn handle_ecs_while_response(
        &mut self,
        stage_response: Option<Box<dyn Any + Send + Sync>>,
        completion_sender: Sender<(
...
pub trait WorkflowStageEcsWhileSE {
    ...
    fn run_ecs_while(
        ...
        state: Self::State,
        world: &mut World,
    ) -> Result<TypedOutcome<Self::State, ()>, Self::Error>;
    fn handle_ecs_while_response(
        &mut self,
        stage_response: Option<Box<dyn Any + Send + Sync>>,
        completion_sender: Sender<(
...
pub trait WorkflowStageEcsWhileSO {
    ...
    fn run_ecs_while(
        ...
        state: Self::State,
        world: &mut World,
    ) -> TypedOutcome<Self::State, Self::Output>;
    fn handle_ecs_while_response(
        &mut self,
        stage_response: Option<Box<dyn Any + Send + Sync>>,
        completion_sender: Sender<(
...
pub trait WorkflowStageEcsWhileSOE {
    ...
    fn run_ecs_while(
        ...
        state: Self::State,
        world: &mut World,
    ) -> Result<TypedOutcome<Self::State, Self::Output>, Self::Error>;
    fn handle_ecs_while_response(
        &mut self,
        stage_response: Option<Box<dyn Any + Send + Sync>>,
        completion_sender: Sender<(
...
pub trait WorkflowStageRenderWhile {
    ...
    fn run_render_while(&mut self, world: &mut World) -> TypedOutcome<(), ()>;
    fn handle_ecs_while_response(
        &mut self,
        stage_response: Option<Box<dyn Any + Send + Sync>>,
        completion_sender: Sender<(
...
pub trait WorkflowStageRenderWhileO {
    ...
    fn index(&self) -> usize;
    fn setup_render_while(&mut self, world: &mut World);
    fn run_render_while(&mut self, world: &mut World) -> TypedOutcome<(), Self::Output>;
    fn handle_ecs_while_response(
        &mut self,
        stage_response: Option<Box<dyn Any + Send + Sync>>,
        completion_sender: Sender<(
