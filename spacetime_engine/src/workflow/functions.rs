...
pub async fn request_workflow<W: WorkflowType>(
...
pub async fn request_workflow_e<W: WorkflowTypeE>(
    request_sender: Sender<WorkflowRequest>,
) -> Result<(), W::Error> {
    let module_name = W::MODULE_NAME;
    let workflow_name = W::WORKFLOW_NAME;
...
pub async fn request_workflow_o<W: WorkflowTypeO>(
    request_sender: Sender<WorkflowRequest>,
) -> Result<W::Output, ()> {
    let module_name = W::MODULE_NAME;
    let workflow_name = W::WORKFLOW_NAME;
...
pub async fn request_workflow_oe<W: WorkflowTypeOE>(
    request_sender: Sender<WorkflowRequest>,
...
pub async fn request_workflow_i<W: WorkflowTypeI>(
    request_sender: Sender<WorkflowRequest>,
    input: W::Input,
) {
    let module_name = W::MODULE_NAME;
...
pub async fn request_workflow_ie<W: WorkflowTypeIE>(
    request_sender: Sender<WorkflowRequest>,
    input: W::Input,
) -> Result<(), W::Error> {
    let module_name = W::MODULE_NAME;
...
pub async fn request_workflow_io<W: WorkflowTypeIO>(
    request_sender: Sender<WorkflowRequest>,
    input: W::Input,
) -> Result<W::Output, ()> {
    let module_name = W::MODULE_NAME;
...
pub async fn request_workflow_ioe<W: WorkflowTypeIOE>(
    request_sender: Sender<WorkflowRequest>,
    input: W::Input,
) -> Result<W::Output, W::Error> {
    let module_name = W::MODULE_NAME;
