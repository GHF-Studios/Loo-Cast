...
// TODO: Redefine and Reimplement this struct completely using the internal commands system
...
pub struct GlobalUniverse {
    ...
    pub(in crate::system::universe) info_hierarchy: InfoHierarchy,
}
...
impl GlobalUniverse {
    ...
    pub(in crate::system::universe) fn get_registered_chunk(
        ...
        let chunk_info_mutex = match self.info_hierarchy.get_chunk_info(chunk_id) {
    ...
    pub(in crate::system::universe) fn get_registered_entity(
        ...
        let entity_info_mutex = match self.info_hierarchy.get_entity_info(entity_id) {
    ...
    pub(in crate::system::universe) fn send_entity_operation_request(
        &mut self,
    ...
    fn register_chunk(
        ...
        self.info_hierarchy.insert_chunk_info(
    ...
    fn unregister_entity(
        commands: &mut Commands,
        parent_chunk: &mut Chunk,
        entity: &crate::system::universe::entity::Entity,
    ...
    fn load_entity_metadata(
        entity: &mut crate::system::universe::entity::Entity,
