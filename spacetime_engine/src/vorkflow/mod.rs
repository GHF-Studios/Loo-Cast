...
pub(in crate) struct VorkflowPlugin;
impl Plugin for VorkflowPlugin {
    fn build(&self, app: &mut App) {
        ...
        app
            .add_event::<VorkflowStageInitializationEvent>()
            .add_event::<VorkflowStageCompletionEvent>()
            .add_persistent_consumable_event::<VorkflowStageInitializationEvent>()
            .add_persistent_consumable_event::<VorkflowStageCompletionEvent>()
            ...
            .insert_resource(VorkflowTypeModuleRegistry::default())
            .insert_resource(VorkflowRequestBuffer::default())
            .insert_resource(VorkflowMap::default())
            ...
            .add_systems(PostUpdate, (
                vorkflow_request_system,
                vorkflow_execution_system.after(vorkflow_request_system),
                vorkflow_completion_handling_system.after(vorkflow_execution_system)
            ));
